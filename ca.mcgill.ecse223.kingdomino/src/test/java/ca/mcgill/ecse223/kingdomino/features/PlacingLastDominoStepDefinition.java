...
public class PlacingLastDominoStepDefinition {
	...
	public void it_is_the_last_turn_of_the_game() {
		assertEquals(KingdominoApplication.getKingdomino().getAllGame(0).hasNextDraft(),false);
	}
	...
	@Then("this player now shall be placing his/her domino ")
	public void this_player_now_shall_be_placing_their_domino() {
